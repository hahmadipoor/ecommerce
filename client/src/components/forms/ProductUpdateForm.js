...
const ProductUpdateForm = ({handleSubmit, handleChange, values, handleCatagoryChange, categories, subOptions, arrayOfSubs, setArrayOfSubs}) => {
  // destructure
  const {title, description, price, category, shipping, quantity, images, colors, brands, color, brand} = values;
